...
class GameScene: SKScene, SKPhysicsContactDelegate /* 追加 */  {
    ...
    func setupScoreLabel() {
        ...
        scoreLabelNode.position = CGPoint(x: self.frame.size.width/10, y: self.frame.size.height - 60)
        ...
        bestScoreLabelNode.position = CGPoint(x: self.frame.size.width/10, y: self.frame.size.height - 90)
